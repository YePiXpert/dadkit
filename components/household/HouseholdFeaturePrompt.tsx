...
export function HouseholdFeaturePrompt() {
  ...
  return (
    <section className="flex min-w-0 items-start gap-3 rounded-card border border-dashed border-primary/30 bg-secondary/35 p-4">
      <Users className="mt-0.5 size-5 shrink-0 text-primary" />
      <div className="min-w-0 flex-1">
        <p className="text-sm font-semibold">添加家庭成员后，可以分配待产任务并标记宝宝记录人。</p>
        <p className="mt-1 text-xs leading-5 text-muted-foreground">也可以暂不设置，清单和宝宝记录仍可正常使用。</p>
