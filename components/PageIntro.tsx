...
export function PageIntro({
  ...
  return (
    <section className={cn("mobile-shell lg:max-w-none", className)}>
      <div className="relative grid grid-cols-[minmax(0,1fr)_4.5rem] gap-3 px-1 sm:hidden">
      ...
      <div className="relative hidden overflow-hidden rounded-lg border border-white/80 bg-card/95 p-4 shadow-soft sm:block sm:p-5">
        ...
        <div className="relative grid grid-cols-[minmax(0,1fr)_5.5rem] gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
          <div className="min-w-0">
