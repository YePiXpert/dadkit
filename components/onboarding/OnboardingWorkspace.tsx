...
export function OnboardingWorkspace() {
  ...
  async function finish() {
    ...
    try {
      ...
      setCurrentMemberId(selectedDraftMemberId ? idMap.get(selectedDraftMemberId) ?? null : null);
      setPreferredEntry(mode === "baby" ? "baby" : mode === "checklist" ? "checklist" : "auto");
      completeOnboarding();
