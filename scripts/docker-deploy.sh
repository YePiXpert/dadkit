...
write_initial_env() {
  ...
  if [ -z "$DADKIT_PORT_WAS_SET$DADKIT_BIND_ADDRESS_WAS_SET$DADKIT_PUBLIC_ORIGIN_WAS_SET$DADKIT_TRUSTED_ORIGINS_WAS_SET$DADKIT_WEBDAV_PROXY_ALLOWED_HOSTS_WAS_SET" ]; then
    return
  fi
