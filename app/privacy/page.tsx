      ...
      <section className="mobile-shell grid gap-5 sm:max-w-[42rem]">
        ...
        <Card>
          ...
          <CardContent className="grid gap-2 text-sm leading-6 text-muted-foreground">
            <p>
              JSON、本地恢复快照和 WebDAV 使用同一份便携备份数据，包括清单、医院档案、家庭显示名称、家庭成员名称与关系、宝宝成长记，以及宝宝昵称、出生资料、全部喂养、吸奶、尿布、睡眠记录、记录人、活动计时、删除墓碑和用户备注。包含宝宝事件的恢复快照保存在 IndexedDB，不写入 localStorage。
            </p>
            <p>
        ...
        <Card>
          ...
          <CardContent className="grid gap-2 text-sm leading-6 text-muted-foreground">
            <p>
              加入家庭同步后，待产清单、医院档案、成长记录、家庭显示名称、成员显示名称与关系和成员删除墓碑会与同一家庭中的设备同步。不同设备对不同字段的修改会按字段时间戳合并。
            </p>
            <p>
