...
const userControls = [
  "在“我的”中管理清单设置和备份恢复",
  "手动上传或下载 WebDAV 备份",
  "导出或完整恢复包含家庭成员、多人负责人和宝宝记录人的 v9 JSON",
  "从自动创建的本地快照恢复完整便携数据",
      ...
      <section className="mobile-shell grid gap-5 sm:max-w-[42rem]">
        ...
        <Card>
          ...
          <CardContent className="grid gap-2 text-sm leading-6 text-muted-foreground">
            <p>
              JSON、本地恢复快照和 WebDAV 使用同一份 v9 便携备份数据，包括清单、医院档案、家庭显示名称、家庭成员名称与关系、多人负责人、宝宝成长记，以及宝宝昵称、出生资料、全部喂养、吸奶、尿布、睡眠记录、记录人、活动计时、删除墓碑和用户备注。包含宝宝事件的 v9 恢复快照保存在 IndexedDB，不写入 localStorage。
            </p>
            <p>
