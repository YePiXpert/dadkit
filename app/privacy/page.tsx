...
const userControls = [
  "在“我的”中管理清单设置和备份恢复",
  "手动上传或下载 WebDAV 备份",
  "导出或完整恢复包含家庭成员、多人负责人和宝宝记录人的完整 JSON",
  "从自动创建的本地快照恢复完整便携数据",
      ...
      <section className="mobile-shell grid gap-5 sm:max-w-[42rem]">
        ...
        <Card>
          ...
          <CardContent className="grid gap-2 text-sm leading-6 text-muted-foreground">
            <p>
              JSON、本地恢复快照和 WebDAV 使用同一份便携备份数据，包括清单、医院档案、家庭显示名称、家庭成员名称与关系、多人负责人、宝宝成长记，以及宝宝昵称、出生资料、全部喂养、吸奶、尿布、睡眠记录、记录人、活动计时、删除墓碑和用户备注。包含宝宝事件的恢复快照保存在 IndexedDB，不写入 localStorage。
            </p>
            <p>
        ...
        <Card>
          ...
          <CardContent className="grid gap-2 text-sm leading-6 text-muted-foreground">
            <p>
              加入家庭同步后，家庭显示名称、成员显示名称与关系、成员删除墓碑、多人负责人、完成期限、预计和实际价格、购买渠道与存放位置会与同一家庭中的设备同步。不同设备对不同字段的修改会按字段时间戳合并。
            </p>
            <p>
              这些信息可能包含家庭安排和消费信息，请只与信任的家庭成员共享邀请链接或短口令，并妥善保管 WebDAV 账号。
            </p>
            <p>
