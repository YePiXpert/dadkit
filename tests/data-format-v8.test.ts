...
import { portableV5, portableV6, portableV7, portableV8 } from "@/tests/helpers/portable-data";
...
describe("DadKit v8 portable format", () => {
  it("validates empty baby data and a complete v8 document", () => {
    ...
    expect(isDadKitImportData(portableV8({ baby }))).toBe(true);
