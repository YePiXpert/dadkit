...
DadKit 是一个本地优先的安心待产准备 PWA。它帮助孕妈和家人按预产期整理今天该做什么、哪些要买、哪些要洗、哪些证件要整理、哪些问题要问医院、家人怎么协作、临出门拿什么，以及如何备份和恢复数据。

DadKit 不是母婴电商清单，不提供购物链接或商品推荐；也不是医疗建议工具或医院官方规则库。所有医院规则、入院动线、陪产要求、提供物品和产后办理材料，都应以最近一次产检、入院须知、医院通知或当地窗口为准。

## 核心功能

- 首页“孕期档案 + 今日行动”：预产期倒计时、当前孕周/阶段、今日优先 3 项、关键进度和主要入口。
- 动态清单：根据预产期、地区、医院、生产方式和用户条件生成待产准备事项。
- PreparationKind 状态语义：购买、清洗、打包、证件、医院问题、协作任务、临出门和安装放置分开处理。
- 清单工作台：移动端优先的自然滚动工具区，集中处理视图切换、进度、筛选和批量入口。
- 购物清单：只显示真正可能需要购买或补货、且未完成的项目。
- 医院确认：区分“下次产检要问”和“爸爸要确认”，清单里的待确认项可直接跳转处理，医院提供物品通过问题回答状态处理。
