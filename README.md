...
DadKit 是一个给孕晚期家庭使用的本地优先待产准备 PWA。v1.3 把全站视觉统一为「精致现代简约风」：暖纸白底、克制的玫瑰主色、统一卡片/行/图标块规范（见 `docs/design/design-system.md`），去掉了贴纸插画和马卡龙渐变。功能上继续把准备方案收束成四根柱子：医院确认、核心待产包、临出门沟通卡和产后提醒，让“现在该做什么、还差什么、能发给谁看”变得更清楚。
